...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-w-full py-6 ">
      <motion.div
      ...
      >
        <article className="bg-card rounded-lg overflow-hidden  transition-all duration-300  w-full">
          <Avatar className="w-32 h-32 sm:float-right mx-auto">
            <AvatarImage
              src={profile.src}
          ...
          <div className="text-sm">
            <p className="my-5 [blockquote_&]:my-2">
              소통을 중요하게 생각하는 소프트웨어 엔지니어 이종수입니다.
            </p>
            <p className="my-5 [blockquote_&]:my-2">
              인생책은 김주환 교수님의 &apos;내면소통&apos;입니다.
            </p>
            <p className="my-5 [blockquote_&]:my-2">
              성공한 삶은 자신이 원하는 삶을 사는 것이라고 생각합니다.
            </p>
            <p className="my-5 [blockquote_&]:my-2">
              정말 사랑스러운 두 아이의 아빠입니다. 좋은 아빠가 되기 위한 고민과
              노력을 하고 있습니다.
            </p>
            <p className="my-5 [blockquote_&]:my-2">미니멀리즘을 추구합니다.</p>
          </div>
        </article>
